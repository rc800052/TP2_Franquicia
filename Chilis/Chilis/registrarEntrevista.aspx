<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarEntrevista.aspx.cs" Inherits="Chilis.registrarEntrevista" %>
...
<body>
    ...
    <asp:Menu ID="Menu1" runat="server" BackColor="#F7F6F3" 
     ...
     <div style="position: absolute; top: 53px; left: 386px;">
        <asp:Label ID="Label1" runat="server" Text="REGISTRAR ENTREVISTA" 
         ...
         <Columns>
             ...
             <asp:TemplateField HeaderText="Descripcion">
                 <ItemTemplate>
                     ...
                     <asp:Label ID="lblBalotario" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"FQ_Balotario_ID") %>' Visible="false" ></asp:Label>
                 </ItemTemplate>
             </asp:TemplateField>
         </Columns>
    ...
    <div style="position: absolute; top: 630px; left: 192px; width: 141px;">
        <asp:Button ID="Button1" runat="server" Text="Aprobar" Width="132px" 
            onclick="btnAprobar_Click" CssClass="Botones" />
    </div>
    <div style="position: absolute; top: 629px; left: 405px; width: 141px;">
        <asp:Button ID="Button2" runat="server" Text="Rechazar" Width="132px" 
            onclick="btnRechazar_Click" CssClass="Botones" />
    </div>
        <div style="position: absolute; top: 626px; left: 726px; width: 141px;">
